---
title: Quick Start
description: Get started with trackle in 5 minutes
---
...
```typescript title="lib/server-analytics.ts"
import { createServerAnalytics } from 'trackle/server';
import { BentoServerProvider } from 'trackle/providers/server';
import type { AppEvents } from './events';
...
```typescript title="lib/server-analytics.ts"
import { createServerAnalytics } from 'trackle/server';
import { PirschServerProvider } from 'trackle/providers/server';
import type { AppEvents } from './events';
...
```typescript title="lib/analytics.ts"
import { createClientAnalytics } from 'trackle/client';
import { PostHogClientProvider, BentoClientProvider } from 'trackle/providers/client';
