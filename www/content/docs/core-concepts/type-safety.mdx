...
One of the biggest advantages of trakoo is full TypeScript support. Define your events once and get autocomplete, type checking, and compile-time validation everywhere.
...
export const appEvents = {
  productsViewed: {
    ...
    category: 'product', // Custom category
    properties: {} as {
      productIds: string[];
...
```typescript
import type { PostHogConfig } from 'trakoo/providers/client';
...
<CardGroup>
  ...
  <Card title="Provider Guides" href="/docs/providers" icon="plug">
    Configure supported analytics providers
  </Card>
</CardGroup>
