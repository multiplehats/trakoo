...
Events in trakoo are defined with full TypeScript support for autocomplete and type safety:
...
`product`, `billing`, `ai`, and other domain-specific categories are valid custom categories.
