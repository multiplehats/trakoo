---
title: Core Concepts
description: Deep dive into the fundamental concepts of trakoo
---

This section covers the fundamental concepts you need to master trakoo. Each guide goes deep into a specific topic with examples and best practices.
...
If you're new to trakoo, we recommend reading these guides in order:
...
- ✅ Installed trakoo and at least one provider
