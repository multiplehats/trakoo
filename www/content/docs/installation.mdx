---
title: Installation
description: Install trackle and your analytics providers
---

import { Step, Steps } from 'fumadocs-ui/components/steps';

Get trackle installed and ready to track events in under 2 minutes.
...
trackle is written in TypeScript and includes full type definitions.
...
If you see `Cannot find module 'trackle/client'`:

1. **Check your package.json**: Ensure `trackle` is installed
...
// ❌ Wrong
import { createClientAnalytics } from 'trackle';
```
...
To completely remove trackle:

```bash
# Remove core library
npm uninstall trackle
