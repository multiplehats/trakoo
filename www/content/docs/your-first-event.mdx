...
import type { CreateEventDefinition, EventCollection } from 'trackle';
...
import { BaseAnalyticsProvider } from 'trackle';
...
```typescript title="lib/analytics.ts"
import { createClientAnalytics } from 'trackle/client';
import { BentoClientProvider } from 'trackle/providers/client';
import type { appEvents } from './events';
...
```typescript title="lib/analytics.ts"
import { createClientAnalytics } from 'trackle/client';
import { PirschClientProvider } from 'trackle/providers/client';
import type { appEvents } from './events';
...
No! You can start with the console logger and add a real provider later. The beauty of trackle is that your tracking code doesn't change when you switch providers.
