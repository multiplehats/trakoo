...
- Ship the OpenPanel transport declarations again ([#40](https://github.com/multiplehats/trakoo/pull/40))
...
- Forward the caller's IP and user agent on OpenPanel server events ([#38](https://github.com/multiplehats/trakoo/pull/38))
