...
One of the biggest advantages of trackle is full TypeScript support. Define your events once and get autocomplete, type checking, and compile-time validation everywhere.
...
```typescript
import type { EventCategory } from 'trackle';
...
```typescript
import type { PostHogConfig } from 'trackle/providers/client';
