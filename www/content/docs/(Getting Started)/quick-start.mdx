---
title: Quick Start
description: Get started with trakoo in 5 minutes
---
...
```typescript title="lib/analytics.ts"
import { createClientAnalytics } from 'trakoo/client';
import { PostHogClientProvider, BentoClientProvider } from 'trakoo/providers/client';
...
<CardGroup>
  ...
  <Card title="Client vs Server" href="/docs/core-concepts/client-vs-server" icon="server">
    Choose the right tracking environment for each event
  </Card>
</CardGroup>
