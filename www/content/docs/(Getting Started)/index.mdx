...
The root `trakoo` import contains shared types and environment-neutral event helpers. Import factories and providers from their client or server subpaths. Providers that wrap a vendor SDK, such as PostHog, come from their own `@trakoo/*` package.
...
<CardGroup>
  ...
  <Card title="Installation" href="/docs/installation" icon="download">
    Install the core package and the provider packages you use.
  </Card>
